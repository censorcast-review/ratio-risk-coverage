...
result=json.loads((ROOT/'results/conditional_heads/REVIEW_COMPARISON.json').read_text())
...
for seed in [20260906,20260907,20260908]:
    files.extend([ROOT/f'results/selective_strong/mean_error_s{seed}.txt',ROOT/f'results/selective_strong/contract_excess_s{seed}.txt',ROOT/f'results/conditional_heads/demand_s{seed}.txt'])
protocol={
 ...
 'design_result_sha256':sha(ROOT/'results/conditional_heads/REVIEW_COMPARISON.json'),
