...
def main(a):
    ...
    for seed in f['seeds']:
        ...
        if dest.exists():pred=load(dest)
            ...
            pred={}
            paths={'error':root/f'results/selective_strong/mean_error_s{seed}.txt','direct':root/f'results/selective_strong/contract_excess_s{seed}.txt','demand':root/f'results/conditional_heads/demand_s{seed}.txt'}
