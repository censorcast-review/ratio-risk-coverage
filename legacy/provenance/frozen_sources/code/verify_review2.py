...
ROOT=Path(__file__).resolve().parents[1];R2=ROOT/'results/review2';G=ROOT.parent/'evaluation_checkpoints'
...
for p,h in f['immutable_files'].items():assert sha(ROOT/p)==h,p
original=G/'GUARDIAN_COMPARISON.json';assert sha(original)=='aaaf3e1f72a576f229f4a31ea42cb46470206cb1dbd33678beb24b9609c0077f'
count=0
for cohort,cache,recordpath in [('design',R2/'cache_design',ROOT/'results/review_revision/REVIEW_COMPARISON.json'),('guardian',G/'cache',original)]:
