...
if __name__=='__main__':
    ap=argparse.ArgumentParser();ap.add_argument('--data',type=Path);ap.add_argument('--out',type=Path,default=ROOT/'results/review8_shared_error');ap.add_argument('--freeze-only',action='store_true');a=ap.parse_args()
