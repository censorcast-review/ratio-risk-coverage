...
PRIOR=ROOT/'results/review7_hobbies'
...
if __name__=='__main__':
    ap=argparse.ArgumentParser();ap.add_argument('--results',type=Path,default=ROOT/'results/review8_shared_error');ap.add_argument('--output',type=Path,default=ROOT/'reproduction_outputs/shared_error_control/AUDIT.json');ap.add_argument('--arrays',action='store_true');a=ap.parse_args();verify(a.results,a.output,a.arrays)
